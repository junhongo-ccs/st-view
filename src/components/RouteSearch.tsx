  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-[max(24px,env(safe-area-inset-bottom))] right-5 z-40 grid h-12 w-12 place-items-center rounded-full border border-white/45 bg-slate-800 text-white shadow-float backdrop-blur-md transition hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-brand md:hidden"
      >
